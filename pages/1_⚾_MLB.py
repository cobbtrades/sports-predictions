...
st.markdown("""
    <style>
        ...
        .prediction-container {border: 1px solid #444444; border-radius: 15px; padding: 15px; margin-bottom: 15px; height: 200px; display: flex; flex-direction: column; justify-content: space-between;}
    </style>
