...
st.markdown("""
    <style>
        ...
        .prediction-container {border: 1px solid #444444; border-radius: 15px; padding: 15px; margin-bottom: 15px; height:300px display: flex; align-items: center; justify-content: center;}
    </style>
