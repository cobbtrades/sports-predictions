...
hide_menu_style = """
    ...
    .stActionCutton {visibility: hidden;}
    </style>
"""
...
team_acronyms = {
    ...
    'Cincinnati Reds': 'CIN', 'Cleveland Guardians': 'CLE', 'Colorado Rockies': 'COL', 'Detroit Tigers': 'DET', 'Houston Astros': 'HOU', 'Kansas City Royals': 'KCR',
    ...
    'New York Yankees': 'NYY', 'Oakland Athletics': 'OAK', 'Philadelphia Phillies': 'PHI', 'Pittsburgh Pirates': 'PIT', 'San Diego Padres': 'SDP', 'Seattle Mariners': 'SEA', 
    'San Francisco Giants': 'SFG', 'St. Louis Cardinals': 'STL', 'Tampa Bay Rays': 'TBR', 'Texas Rangers': 'TEX', 'Toronto Blue Jays': 'TOR', 'Washington Nationals': 'WSN'
}
                    ...
                    <div class="prediction-container">
                        <div style="display: flex; align-items: center; margin-bottom: 15px;">
                            <figure style="margin-right: 10px; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                                <img src="data:image/svg+xml;base64,{home_logo_base64}" alt="{row['Home Team']} Logo" style="height: 80px;">
                            ...
                            <figure style="margin-left: 10px; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                                <img src="data:image/svg+xml;base64,{away_logo_base64}" alt="{row['Away Team']} Logo" style="height: 80px;">
